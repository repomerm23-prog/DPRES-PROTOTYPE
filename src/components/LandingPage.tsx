        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative">
              <ImageWithFallback 
                src="https://images.unsplash.com/photo-1755548413928-4aaeba7c740e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbWVyZ2VuY3klMjB0cmFpbmluZyUyMGRyaWxsJTIwc2Nob29sJTIwc3R1ZGVudHN8ZW58MXx8fHwxNzU3ODM0MjM2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=designkit&utm_medium=referral"
